/**
 * Thin helpers over the arrival-sugarcoat `Node` parse forest. The projection lowers
 * this forest; everything here is pure shape inspection — no emit, no naming.
 */
import type { Node } from "@inhuman.tools/arrival-sugarcoat";
...
export { type Node } from "@inhuman.tools/arrival-sugarcoat";
