 ...
 * `@inhuman.tools/arrival`'s provenance subpath surfaces (re-exported, unchanged, by the
 * `@inhuman.tools/arrival-provenance` shim) — so a UI can render and select over the
