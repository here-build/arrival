...
export const CROSSINGS: readonly CrossingRow[] = [
  ...
  { type: "bigint", entryForm: "raw passthrough (opaque host value — not a scheme number)", exitForm: "raw (unchanged — same bigint identity)", roundTrip: true }, // §2.3: bigint is opaque, never boxed into an AExact (docs/working-proposals/arrival-one-number-rework.md)
