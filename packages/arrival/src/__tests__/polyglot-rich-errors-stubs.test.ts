// The cross-dialect teaching-stub pack (`env/polyglot-rich-errors/stubs.ts`):
...
//
// This is the STUBS half of the `polyglot-rich-errors` sub-capability; the
// TYPO-ENRICHMENT half (`./registry.ts`'s `richErrorFor`) is tested separately in
...
import wellKnownStubs from "../env/polyglot-rich-errors/stubs.js";
