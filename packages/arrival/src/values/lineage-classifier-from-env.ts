/**
 * Builds a `Classifier` for `classify()` (./lineage.ts) from a live `Environment` by
 ...
 *
 * The legacy dynamic `Environment.defineRosetta`/`RosettaFunction.pure` runtime API is
