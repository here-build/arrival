...
// Rows below go through `{ capabilities: [overridableCapability], config: { params } }`
// — the door `execState`'s router uses for the capability. There is no `ExecOptions.override`
// sugar.
