...
export default new EnvCapability("scheme/combinators", {
  symbols: {
    ...
    take: {
      value(lst: unknown, n: unknown): Pair | typeof nil {
    ...
    drop: {
      value(lst: unknown, n: unknown): unknown {
        const count = toIndex(n);
        let current = lst;
        let i = 0;
    ...
    range: {
      value(stopOrStart: unknown, ...rest: unknown[]): Pair | typeof nil {
    ...
    complement: {
      value(fn: (...args: unknown[]) => unknown): (...args: unknown[]) => unknown {
    ...
    always: {
      value(constant: unknown): (...args: unknown[]) => unknown {
    ...
    "n-ary": {
      value(n: unknown, fn: (...args: unknown[]) => unknown): (...args: unknown[]) => unknown {
        const count = toIndex(n);
