...
export default new EnvCapability("scheme/chars", {
  symbols: {
    ...
    "digit-value": {
      value(char: unknown): number | false {
    ...
    // Case conversion
    "char-upcase": {
      value(char: unknown): SchemeCharacter {
    ...
    "char->integer": {
      value(char: unknown): SchemeExact {
    ...
    "integer->char": {
      value(n: unknown): SchemeCharacter {
